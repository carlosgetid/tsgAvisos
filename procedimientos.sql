...
SELECT*FROM [dbo].[TBCAS_AVISO_COMENTARIO]

EXEC SP_LISTAR_COMENTARIO '9999',9999
GO
...
AS
BEGIN
	SELECT A.[EMPRESA_CODIGO],A.[AVISO_CODIGO],[AVISOARCH_USUARIO],B.[AVISOARCH_CODIGO],[AVISO_ARCHIVO],[AVISO_RUTA],[AVISOARCH_SYS_EST]
...
exec SP_LISTAR_ADJUNTOS '9999',9999
